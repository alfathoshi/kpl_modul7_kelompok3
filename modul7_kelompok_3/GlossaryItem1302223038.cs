...
public class GlosarryItem1302223038
{
    ...
    {
        string json = File.ReadAllText("jurnal7_3_1302223038.json");

        var glosarryItem = JsonSerializer.Deserialize<GlosarryItem1302223038>(json);
